...
const placesData = {
    ...
    phuket: [
        ...
        },
        {
            ...
            description: "จุดชมวิวที่สามารถมองเห็นอ่าวต่างๆ ได้อย่างสวยงาม ตั้งอยู่ในบริเวณที่สามารถมองเห็นทิวทัศน์ของอ่าวที่สวยงามสามแห่ง ได้แก่ อ่าวป่าตอง, อ่าวกะตะ, และ อ่าวกะรน บนเกาะภูเก็ต จุดชมวิวนี้เป็นจุดที่มีชื่อเสียงในหมู่นักท่องเที่ยวที่ต้องการชมวิวทะเลที่กว้างไกลและหลากหลายมุมมอง บริเวณจุดชมวิวมีพื้นที่กว้างขวางที่เหมาะสำหรับการถ่ายภาพ และพักผ่อนท่ามกลางธรรมชาติ",
            image: "karon_view_point.jpg"
        },
        {
            name: "ย่านเมืองเก่าภูเก็ต",
            description: "ย่านเมืองเก่าที่มีสถาปัตยกรรมแบบ Sino-Portuguese ที่สวยงาม เป็นหนึ่งในสถานที่ที่มีความสำคัญทางประวัติศาสตร์และวัฒนธรรมของภูเก็ต มีสถาปัตยกรรมแบบ Sino-Portuguese ซึ่งเป็นการผสมผสานระหว่างวัฒนธรรมจีนและโปรตุเกส ทำให้ย่านนี้เต็มไปด้วยความงดงามในแบบที่ไม่เหมือนใคร โดยเฉพาะการตกแต่งของอาคารบ้านเรือนที่ มีสีสันสดใสและลวดลายที่โดดเด่น",
    ...
    suratthani: [
        ...
        {
            name: "ลานหินโค้ง",
            description: "ความมหัศจรรย์ทางธรณีวิทยา เป็นแหล่งท่องเที่ยวทางธรรมชาติที่มีความโดดเด่นในด้านธรณีวิทยา เป็นสถานที่ที่มีหินที่เกิดจากกระบวนการทางธรรมชาติที่น่าทึ่ง รวมถึงหินที่มีรูปทรงโค้งซึ่งเป็นผลจากการกัดเซาะของน้ำและลมในระยะเวลานาน ที่นี่เป็นจุดหมายสำหรับนักท่องเที่ยวที่ชื่นชอบการศึกษาธรรมชาติและความสวยงามของการสร้างสรรค์ทางธรณีวิทยา",
        ...
        },
        {
            ...
            description: "น้ำตกที่สวยงามในอุทยานแห่งชาติเขาสก ตั้งอยู่ในอุทยานแห่งชาติเขาสก เป็นหนึ่งในน้ำตกที่มีความงดงามและได้รับความนิยมจากนักท่องเที่ยวที่ชื่นชอบธรรมชาติ น้ำตกนี้มีความสวยงามจากการไหลลงมาจากหน้าผาสูง ผ่านชั้นหินหลายชั้นในลักษณะที่สวยงาม และมีความใสของน้ำที่สะท้อนแสงได้อย่างน่าประทับใจ",
        ...
        {
            name: "Hug Village",
            description: "สถานที่ท่องเที่ยวเชิงวัฒนธรรม เป็นสถานที่ท่องเที่ยวที่เน้นการเรียนรู้และสัมผัสกับวัฒนธรรมท้องถิ่นอย่างลึกซึ้ง ที่นี่นักท่องเที่ยวสามารถสัมผัสวิถีชีวิตและประเพณีท้องถิ่นที่ยังคงความเป็นเอกลักษณ์ของพื้นที่เอาไว้ได้อย่างดีเยี่ยม โดยมีหลากหลายกิจกรรมที่เกี่ยวข้องกับวัฒนธรรมและงานฝีมือท้องถิ่น ซึ่งเหมาะสำหรับผู้ที่ต้องการเรียนรู้และสัมผัสกับความเป็นไทยในแบบดั้งเดิม",
            image: "hug_village.jpg"
        },
        {
            name: "ตลาดศาลเจ้า",
            description: "สัมผัสวิถีชีวิตและวัฒนธรรมท้องถิ่น เป็นหนึ่งในสถานที่ท่องเที่ยวที่สะท้อนถึงวิถีชีวิตและวัฒนธรรมของ ชุมชนท้องถิ่นที่นี่ไม่เพียงแค่เป็นแหล่งช้อปปิ้ง แต่ยังเป็นจุดที่นักท่องเที่ยวสามารถสัมผัสถึงความหลากหลายทางวัฒนธรรมและประเพณีอันยาวนานของพื้นที่ ตลาดศาลเจ้าเต็มไปด้วยร้านค้าที่ขายสินค้าท้องถิ่น อาหารพื้นบ้าน และของที่ระลึกที่สะท้อนถึงวิถีชีวิตของคนในชุมชน",
