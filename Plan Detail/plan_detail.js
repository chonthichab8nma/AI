...
const placesData = {
    ...
    nakhonsithammarat: [
        ...
        {
            name: "6. หาดสิชล",
            description: "หาดทรายสวยงาม เหมาะสำหรับการพักผ่อนและเล่นน้ำทะเล เป็นหาดที่ขึ้นชื่อเรื่องความสวยงามของ ทรายขาวและน้ำทะเลใส เหมาะสำหรับนักท่องเที่ยวที่ต้องการพักผ่อนในบรรยากาศเงียบสงบ ท่ามกลางธรรมชาติที่สมบูรณ",
            image: "fossil_shell_beach.jpg"
        },
        {
            name: "7. หาดขนอม",
